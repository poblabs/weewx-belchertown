    ...
    def __init__(self):
        super(ExfoliationInstaller, self).__init__(
            ...
            files=[('bin/user', 
                   ...
                   ('skins/Belchertown/about',
                     ['skins/Belchertown/about/index.html.tmpl']),
                   ('skins/Belchertown/graphs',
                     ['skins/Belchertown/graphs/index.html.tmpl']),
                   ...
                   ('skins/Belchertown/reports',
                     ['skins/Belchertown/reports/index.html.tmpl']),
                   ...
                   ('skins/Belchertown/json',
                     ['skins/Belchertown/json/day.json.tmpl',
                     'skins/Belchertown/json/week.json.tmpl',
                     'skins/Belchertown/json/month.json.tmpl',
                     'skins/Belchertown/json/year.json.tmpl',
